...
const Boxes = () => {
  ...
  return (
    <div className="flex justify-around w-full max-w-6xl mb-16">
        {/* Formik Box */}
        <div className="bg-sky-50 p-8 rounded-lg shadow-lg w-full md:w-1/2 m-10">
          <div className="flex justify-center mb-4">
            <img src="https://i.ibb.co/GcXcKzp/20e6b8d4515c7e1ed6f1db25a2a3d3f2-2.png" alt="Formik Logo" className="w-16 h-16 rounded-full" />
          </div>
          <h2 className="text-2xl font-bold mb-4 text-center">Formik & Yup</h2>
        ...
        {/* React Hook Form Box */}
        <div className="bg-rose-50 p-8 rounded-lg shadow-lg w-full md:w-1/2 m-10">
          <div className="flex justify-center mb-4">
            <img src="https://i.ibb.co/0Mbjj1j/react-hook-form-logo-only-removebg-preview.png" alt="React Hook Form Logo" className="w-16 h-16 rounded-full bg-rose-50 "   />
          </div>
          <h2 className="text-2xl font-bold mb-4 text-center">React Hook Form & Zod</h2>
          <p className="mb-4 text-gray-700">
